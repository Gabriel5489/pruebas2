...
MySQL - 5.5.5-10.4.20-MariaDB : Database - dbhuasteca2
*********************************************************************
*/
...
insert  into `password_resets`(`email`,`token`,`created_at`) values ('bria35@example.org','$2y$10$zLHSHD/9FGanpYiY16oAe.d80Pp3YCuxADkTwFwPIruMHu6irriz6','2021-03-30 01:35:13'),('angel_1999barsa@gmail.com','$2y$10$V40qou0XOZjLAy3ZZffzgeI.QkYEKClVHboeZ8HkCx5CyY3X0S.PC','2021-03-30 11:28:32'),('angel.barsa1999@gmail.com','$2y$10$nXHNSZyFeiO5hw7bSasX5e.5OraBSLjKRoKm4gzKKkW1SYzjlx2ny','2021-08-10 08:26:33'),('aadlcg1999@gmail.com','$2y$10$7VvKJt4vkk6Rm7R88jHy8O7tnmeYSfC4fYaQBrCgQjxjxDw3Gs//K','2021-08-12 21:52:05'),('angel.1999barsa@gmail.com','$2y$10$Xpd8baPP.IMuLfIpMhaiQuVXVOFDzbtocNehJuBnTKnfmhWUwEvr6','2021-08-20 12:36:41');
...
insert  into `sessions`(`id`,`user_id`,`ip_address`,`user_agent`,`payload`,`last_activity`) values ('D8ucdvokoSflaAB6au0N8uab3muvHjVVsMPTd4n9',NULL,'192.168.0.4','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36','YTozOntzOjY6Il90b2tlbiI7czo0MDoiSGx2ZGNDc3FDM0JuYklZcG9tNkRhSmJ6MEY1MG9iVnJtOW1hYXhCbCI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzA6Imh0dHA6Ly8xOTIuMTY4LjAuNDo4MDAwL0luaWNpbyI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=',1631569692),('WcgjOAOsFqJiaCVq9r5a7rAvAD3DFM3lkEByvzTb',NULL,'192.168.0.4','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Safari/537.36','YTozOntzOjY6Il90b2tlbiI7czo0MDoiWks5RXRMUWxCOFBNeklWSzdCQWozbEl1Y25udDF4RDFqSnptV3IyMSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzA6Imh0dHA6Ly8xOTIuMTY4LjAuNDo4MDAwL0luaWNpbyI7fX0=',1629482061);

UNLOCK TABLES;

/*Table structure for table `tblcarritos` */

DROP TABLE IF EXISTS `tblcarritos`;

CREATE TABLE `tblcarritos` (
  ...
  CONSTRAINT `tblcarritos_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tblcarritos_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `tblproductos` (`intIDProd`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tblcarritos` */

LOCK TABLES `tblcarritos` WRITE;

insert  into `tblcarritos`(`idCarrito`,`idUsuario`,`idProducto`,`intCantidad`,`fltTotal`) values (34,97,62,2,1600),(35,97,74,2,440),(53,95,75,36,15804);
...
insert  into `tblcats`(`intIdCat`,`vchCat`,`created_at`,`updated_at`) values (1,'Caballero',NULL,NULL),(2,'Dama',NULL,NULL),(3,'Infantil',NULL,NULL),(4,'Unisex',NULL,NULL);
...
insert  into `tbldirecciones`(`idDirecciones`,`vchTitulo`,`idUsuario`,`vchDireccion`,`vchCodigo`,`vchPoblacion`,`vchEstado`,`vchPais`,`vchTelefono`) values (13,'Mi casa',92,'Col. Colalambre','43000','Huejutla','Hidalgo','Mexico','1234567890'),(17,'Jdjdbdfda2',19,'Vfbdvvdvdb','53000','Dbdbdbddd','Texas','USA','Uuuuuu'),(18,'Fjfnfbfb',10,'Dbdbdbd','85620','Xjdbbdbdbd','Arizona','USA','Jdjxjxxj'),(19,'Fjfnfbfb',12,'Dbdbdbd','85620','Xjdbbdbdbd','Arizona','USA','Jdjxjxxj'),(20,'Fjfnfbfb',15,'Dbdbdbd','85620','Xjdbbdbdbd','Hidalgo','Mexico','Jdjxjxxj'),(21,'Fjfnfbfb',16,'Dbdbdbd','85620','Xjdbbdbdbd','Veracruz','Mexico','Jdjxjxxj'),(22,'Fjfnfbfb',17,'Dbdbdbd','85620','Xjdbbdbdbd','Jalisco','Mexico','Jdjxjxxj'),(24,'Casa',95,'del carmen','43000','Huejutla','Hidalgo','Mexico','7716838276'),(25,'Casa',97,'20 de abril','43000','Huejutla','Hidalgo','México','7716838276'),(26,'Escuela',95,'Col tepoxtequito km5','43000','Huejutla','Hidalgo','México','7716838276');
...
insert  into `tblfavoritos`(`idFavorito`,`idUser`,`idProducto`) values (15,95,71),(16,97,55),(17,95,55);

UNLOCK TABLES;

/*Table structure for table `tblnotificaciones` */

DROP TABLE IF EXISTS `tblnotificaciones`;

CREATE TABLE `tblnotificaciones` (
  `intIDNoti` int(11) NOT NULL AUTO_INCREMENT,
  `intUser_id` int(11) DEFAULT NULL,
  `intProd_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`intIDNoti`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tblnotificaciones` */

LOCK TABLES `tblnotificaciones` WRITE;

insert  into `tblnotificaciones`(`intIDNoti`,`intUser_id`,`intProd_id`,`created_at`,`updated_at`) values (7,92,74,'2021-08-02 17:50:02','2021-08-02 17:50:02'),(11,19,62,'2021-10-01 03:54:16','2021-10-01 03:54:16'),(12,10,71,'2021-07-07 03:56:31','2021-07-07 03:56:31'),(13,12,60,'2021-08-03 06:30:53','2021-08-03 06:30:53'),(14,15,61,'2021-07-08 06:31:15','2021-07-08 06:31:15'),(15,16,70,'2021-03-01 06:31:51','2020-11-01 06:31:56'),(16,17,71,'2021-02-04 06:32:58','2021-02-04 06:32:58'),(17,19,77,'2021-06-17 06:34:23','2021-06-17 06:34:23');
...
insert  into `tblventadets`(`intIdVentaDet`,`intIdVenta`,`intIDProd`,`intCant`,`fltPrecio`,`created_at`,`updated_at`) values (24,23,74,3,220,'2021-08-12 21:30:45','2021-08-12 21:30:45'),(25,23,52,2,500,'2021-08-12 21:30:45','2021-08-12 21:30:45'),(26,23,59,1,1500,'2021-08-12 21:30:45','2021-08-12 21:30:45'),(27,24,75,3,439,'2021-08-18 15:19:07','2021-08-18 15:19:07'),(28,24,73,4,460,'2021-08-18 15:19:07','2021-08-18 15:19:07'),(29,25,77,6,460,'2021-08-19 12:34:23','2021-08-19 12:34:23'),(30,25,70,1,35,'2021-08-19 12:34:23','2021-08-19 12:34:23'),(31,26,76,1,430,'2021-08-19 15:37:48','2021-08-19 15:37:48'),(32,27,77,1,460,'2021-09-13 17:40:06','2021-09-13 17:40:06'),(33,27,69,2,36,'2021-09-13 17:40:06','2021-09-13 17:40:06');
...
CREATE TABLE `tblventas` (
  ...
  `vchIdPayment` varchar(40) DEFAULT NULL,
  `intUser_id` int(11) DEFAULT NULL,
  `intDireccion_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
insert  into `tblventas`(`intIdVenta`,`Total_Venta`,`vchIdPayment`,`intUser_id`,`intDireccion_id`,`created_at`,`updated_at`) values (23,3160,'ch_3JNqATGSqsqx8ql02Vk7Du6s',95,26,'2021-08-12 21:30:45','2021-08-12 21:30:45'),(24,3157,'ch_3JPvE8GSqsqx8ql03a63ZvEy',95,26,'2021-08-18 15:19:07','2021-08-18 15:19:07'),(25,2795,'ch_3JQF8EGSqsqx8ql0123FiYSV',95,24,'2021-08-19 12:34:23','2021-08-19 12:34:23'),(26,430,'ch_3JQHzkGSqsqx8ql00o11hsYh',95,24,'2021-08-19 15:37:48','2021-08-19 15:37:48'),(27,532,'ch_3JZNoqGSqsqx8ql03RErX2Tp',95,26,'2021-09-13 17:40:05','2021-09-13 17:40:05');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_carrito` AS (select `tblcarritos`.`idCarrito` AS `idCarrito`,`users`.`id` AS `idUsuario`,`users`.`name` AS `name`,`tblproductos`.`intIDProd` AS `idProducto`,`tblproductos`.`vchProd` AS `vchProd`,`tblproductos`.`vchDesc` AS `vchDesc`,`tblproductos`.`vchImg` AS `vchImg`,`tblproductos`.`fltPrecio` AS `fltPrecio`,`tblcarritos`.`intCantidad` AS `intCant`,`tblcarritos`.`fltTotal` AS `fltTotal` from ((`tblcarritos` join `users`) join `tblproductos`) where `tblcarritos`.`idProducto` = `tblproductos`.`intIDProd` and `tblcarritos`.`idUsuario` = `users`.`id`) */;
